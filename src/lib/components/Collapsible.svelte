...
{#if expandable}
	<button
		class="rounded-sm text-muted underline decoration-transparent underline-offset-2 outline-hidden outline-offset-4 transition focus-visible:outline-contrast hv:decoration-current"
